...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    money_exchanged = exchange_money(budget, actual_exchange_rate)
    number_of_bills = get_number_of_bills(money_exchanged, denomination)
...
def non_exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    money_exchanged = exchange_money(budget, actual_exchange_rate)
    number_of_bills = get_number_of_bills(money_exchanged, denomination)
    non_exchanged = money_exchanged - get_value_of_bills(denomination, number_of_bills)
    return int(non_exchanged)
